...
async function buildProject() {
  ...
  try {
    ...
    console.log('\nBuild statistics:');
    console.log(chalk.cyan(`  Client bundle size: ${(clientStats.size / 1024 / 1024).toFixed(2)} MB`));
    console.log(chalk.cyan(`  Server bundle size: ${(serverStats.size / 1024 / 1024).toFixed(2)} MB`));
