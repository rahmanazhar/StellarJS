...
- fix(release): Remove unnecessary variables and streamline semantic-release command ([850f667](https://github.com/rahmanazhar/StellarJS/commit/850f667))
...
- feat(release): Add semantic release configuration and verify config file existence ([e5f1a39](https://github.com/rahmanazhar/StellarJS/commit/e5f1a39))
- style: Fix prettier formatting issues ([bd63a1c](https://github.com/rahmanazhar/StellarJS/commit/bd63a1c))
